...
env_setup_vm(struct Env *e)
{
	...
	// LLM Prompt: Explain the setup logic of the page directory for the environment
	// LAB 3: Your code here.
...
region_alloc(struct Env *e, void *va, size_t len)
{
	...
	// LLM Prompt: Explain the logic of the region_alloc function, check if the code i have written is correct
...
env_create(uint8_t *binary, enum EnvType type)
{
	...
	// Loading the ELF binary into the environment
	load_icode(e, binary);
...
env_run(struct Env *e)
{
	...
	// setting the current environment to the new environment
	curenv = e;
	curenv->env_status = ENV_RUNNING;
	curenv->env_runs++;
	
	// switching to the new environment's address space
